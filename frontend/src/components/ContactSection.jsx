...
export default function ContactSection() {
  return (
    <section id="contact" className="info-page section-wrapper">
        ...
        <div className="split-layout">
            ...
            <div className="info-section">
              ...
              <p className="info-text mb-8">
                ...
                Our team represents the intersection of human expertise and AI efficiency.
                Reach out for demos, support, or partnership opportunities.
              </p>
              ...
              <div className="space-y-6">
                  ...
                  <div className="contact-item">
                    <div className="contact-icon"><Bot size={20} /></div>
                     <div>
                         <p className="text-sm text-gray-400">AI Agent Support</p>
                         <p className="text-lg">Live Chat (Available for Admin)</p>
                    </div>
                  </div>
              </div>
            </div>
            ...
            <div className="info-section contact-form-card">
                ...
                <form className="space-y-4">
                    ...
                    <div className="form-group">
                        ...
                        <textarea placeholder="Tell us about your requirements..." rows="3" className="form-textarea"></textarea>
                    </div>
