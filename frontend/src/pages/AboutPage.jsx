      ...
      <div className="section-wrapper" style={{ paddingBottom: "2rem" }}>
        <div className="info-container">
          ...
          <div className="info-section">
            ...
            <p className="info-text">
              We envision a future where McDonald's branches operate with
              seamless efficiency. Imagine a world where rosters build
              themselves, conflicts are resolved before they happen, and every
              employee is perfectly matched to their best shifts. That is the
              future we are building today.
            </p>
          </div>
